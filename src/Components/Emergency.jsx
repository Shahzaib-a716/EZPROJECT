    ...
    <div className="flex justify-center min-h-screen items-center bg-gray-700">
      <div id="step1" className="relative w-3/5 p-4 rounded-lg">
        ...
        <img
          ...
          alt="Left Icon"
          className="absolute top-[calc(19rem)] right-[755px] h-[445px] w-10 object-cover cursor-pointer" // Adjusted top value
          onClick={handlePreviousMonth}
        />
        <img
          src="/assets/images/arrrow3.webp"
          alt="Right Icon"
          className="absolute top-[calc(19rem)] left-[755px] h-[445px] w-10 object-cover cursor-pointer" // Adjusted top value
  ...
  <div className="flex flex-col text-white">
    ...
    <div className="flex gap-2">
      ...
      <h1>06:00PM - 11:59PM</h1>
        ...
        {/* Calendar Section */}
        <div className="mt- justify-end p-10">
          <h1 className="text-center text-xl text-white justify-end bg-gradient-to-b from-[#FFCC00] to-[#FF6600] p-2 w-[250px]">
