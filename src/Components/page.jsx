        ...
        <div className="entry-content">
          <div className="et-l">
            <div className="et_builder_inner_content">
              ...
              {/* Section 1 */}
              <div className="relative bg-cover bg-center h-[774px]" style={{ backgroundImage: 'url(https://ez12.hu/wp-content/uploads/2022/05/business-14.jpg)' }}>
                <section className="text-center text-white flex items-center justify-center h-full bg-opacity-50 bg-black">
                  <div>
                    <h1 className="text-4xl font-bold">Motor Home Modification & Customization</h1>
                    <p className="mt-4">We can create the environment you wish to live in. You are only as good as the people around you.</p>
                  </div>
                </section>
              </div>
              ...
              <div className="bg-gray-100 py-12">
                <h2 className="text-center text-2xl font-bold">First Motor Home in Europe</h2>
              ...
              <div className="bg-white py-12">
                <h2 className="text-center text-2xl font-bold">2nd Motor Home in Europe</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                  <div className="aspect-w-16 aspect-h-9">
                    <iframe
              ...
              {/* Section 4 */}
              <div className="bg-gray-100 py-12">
                <h2 className="text-center text-2xl font-bold">My 3rd Motor Home</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                  ...
                  <div className="aspect-w-16 aspect-h-9">
                    <iframe
                      title="Doing laundry and drying it. WOW!"
                  ...
                  <div className="aspect-w-16 aspect-h-9">
                    <iframe
                      title="Getting things done on my motorhome"
              ...
              {/* Section 5 */}
              <div className="bg-white py-12">
                <h2 className="text-center text-2xl font-bold">The latest Motor Home</h2>
                <p className="text-center mt-4">QC924 LeVoyageur Car 2018 version Purchased in 2020. My Version is LeVoyageur Plus.</p>
                ...
                <div className="mt-8 flex justify-center">
                  <div className="aspect-w-16 aspect-h-9">
                    <iframe
                      title="Solar on my Motor Home in Europe"
